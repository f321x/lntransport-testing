...
from electrum_lntransport import *
from aiorpcx import TaskGroup

from .util import needs_test_with_all_chacha20_implementations


class TestLNTransport(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_responder(self):
        ...
        class Reader:
            ...
            async def read(self, num_bytes):
                ...
                return None
        transport = LNTransport(ls_priv, Reader(), Writer())
